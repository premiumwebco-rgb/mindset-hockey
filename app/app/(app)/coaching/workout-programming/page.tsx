...
export const metadata = { title: 'Custom Workout Programming — Mindset Hockey' };
export const dynamic = 'force-dynamic';

/* ==========================================================================
   CUSTOM WORKOUT PROGRAMMING — one of the 4 Personalized Plan tabs. Shows
   ONLY this member's own member_coaching_content rows (content_type =
   'workout') — enforced twice over, same defence-in-depth pattern as the
...
export default async function WorkoutProgrammingPage() {
  ...
  return (
    <div>
      ...
      <h1 className="display text-[clamp(28px,5vw,44px)]">Custom Workout Programming</h1>
      <p className="mt-3 max-w-[62ch] text-[16px] text-silver">
        Personalized gym and training programming built around your goals and schedule. This is
      ...
      <div className="mt-8">
        {rows.length === 0 ? (
          <EmptyState
            ...
            body="Your coach hasn't added your workout programming yet — check back soon, or reach out if you're expecting something."
          />
        ) : (
