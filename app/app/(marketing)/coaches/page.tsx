...
export const metadata: Metadata = {
  ...
  description:
    'Meet the Mindset Hockey coaching staff: Brayden Castiglia, owner and lead coach, and Jack Magill, a Jr hockey development coach and NCAA prospect, training players in Waldorf, MD.',
  ...
  employee: [
    {
      ...
      description:
        'Coach, founder and owner of Mindset Hockey. Jr hockey player who progressed from 16U A to AAA to Jr hockey. Owns the business and oversees all player development systems, program direction and coaching standards.',
    },
    {
      '@type': 'Person',
      jobTitle: 'Development Coach',
      name: 'Jack Magill',
      description: 'Jr hockey player and NCAA prospect. Skill development specialist and player mentor at Mindset Hockey.',
    },
  ],
};
      ...
      <section style={{ paddingBottom: '30px' }}>
        ...
        <div className="wrap">
          <div className="head center">
            ...
            <p className="lede mt2">Two coaches, both current Jr hockey players. Our staff combines leadership, experience and a passion for player development — helping athletes improve their skills, confidence and understanding of the game, on and off the ice. One of us owns the program; both of us coach it.</p>
          ...
          <div className="staff">
            <article className="coach lead rv">
              ...
              <div className="coach-body">
                ...
                <ul className="chips">
                  <li>Jr Hockey Player</li><li>Program Founder</li><li>Business Owner</li>
                  <li>Lead Coach</li><li>Former Alternate Captain</li>
                </ul>
                <p>I started Mindset Hockey because nobody coached me on the two things that actually changed my career — my shot mechanics and how I thought. I was a 16U A player who broke his rib twice, lost most of two seasons, rebuilt from zero, earned a letter, moved up to AAA and signed with a Jr hockey organization.</p>
            ...
            <article className="coach rv">
              <div className="coach-photo">
                ...
                <img src="/media/coach-jack-headshot.jpg" alt="Coach Jack Magill, Mindset Hockey development coach, in a Utica Jr. Comets USPHL jersey" width={620} height={619} />
              </div>
              <div className="coach-body">
                <h3>Coach Jack Magill</h3>
                <p className="coach-role">Development Coach · Jr Hockey Player</p>
                <ul className="chips">
                  <li>Jr Hockey Player</li><li>NCAA Prospect</li>
                ...
                <p>That work took him from Single-A at 16 to competing at the Jr hockey level by 20, where he has served as a captain. He&apos;s currently exploring opportunities with NCAA programs as he continues chasing the next level.</p>
      ...
      <section className="band">
        <div className="wrap">
          <div className="head center rv">
            <p className="eyebrow center">Coach Jack Magill · game film</p>
            <h2>He&apos;s still playing<br />at the level you&apos;re chasing</h2>
            <p className="lede mt2">Real Jr hockey game film. The point isn&apos;t highlights — it&apos;s that the person coaching your player is competing at the level right now, not describing it from memory.</p>
          </div>
          <div className="compare rv">
            <div className="facade" data-lf-video="" data-video-src="/media/coach-jack-clip-1.mp4" data-video-title="Coach Jack game film 1" role="button" tabIndex={0} aria-label="Play Coach Jack game film, clip one">
              <span className="tag">Jr hockey · game film</span>
            ...
            <div className="facade" data-lf-video="" data-video-src="/media/coach-jack-clip-2.mp4" data-video-title="Coach Jack game film 2" role="button" tabIndex={0} aria-label="Play Coach Jack game film, clip two">
              <span className="tag">Jr hockey · game film</span>
              <img src="/media/poster-coach-clip-2.jpg" alt="Jr hockey game film still showing a rush entering the offensive zone" width={1172} height={540} loading="lazy" />
              <span className="play"><span><svg width="20" height="24" viewBox="0 0 22 26" fill="#fff" aria-hidden="true"><path d="M22 13 0 26V0z" /></svg></span></span>
      ...
      <section>
        <div className="wrap">
          ...
          <div className="cards c3">
            ...
            <article className="card rv"><span className="num">02</span><h3>Coach Jack Magill develops the skills</h3><p>Skill sessions, shot rebuilds and mentoring from someone currently competing at the Jr hockey level and pursuing NCAA opportunities — recent enough to remember every step of the climb.</p></article>
