    ...
    <>
        ...
        <div className="wrap">
          <div className="split">
            <div className="rv">
              ...
              <p className="mt2"><Link className="btn btn-primary" href="/pricing#membership" data-plan="membership" data-cta="program_shot" data-cta-location="programs">Get Your Shot Analyzed</Link></p>
              <p className="mt2 small muted"><b className="hl">AI Shot Analysis is included with Membership.</b> Upload a clip from your phone and it grades ten mechanics categories, telling you what it could see and how confident it is. It reads video frames — it is not a biomechanics lab, and anything the footage does not show clearly comes back marked rather than guessed at.</p>
            </div>
      ...
      <section className="band" id="mindset">
        <div className="wrap">
          <div className="split rev">
            ...
            <div className="rv">
              <p className="eyebrow">Program 02 · Included with Membership</p>
              <h2 style={{ fontSize: 'clamp(24px,4vw,38px)' }}>Mindset development<br />training</h2>
              <p className="lede mt2">Physical skills are only part of the equation. Our members receive guidance on confidence, discipline, accountability and mental performance so they can perform at their best both on and off the ice.</p>
              <ul className="ticks">
              ...
              <p className="mt2"><Link className="btn btn-primary" href="/pricing#membership" data-plan="membership" data-cta="program_mindset" data-cta-location="programs">See What&apos;s Included</Link></p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="mindset-topics">
        ...
        <div className="wrap">
          ...
          <p className="center mt3"><Link className="btn btn-primary btn-lg" href="/pricing#membership" data-plan="membership" data-cta="mindset_membership" data-cta-location="programs_mindset">Mindset Training Is Included With Membership</Link></p>
        </div>
      </section>
      ...
      <section className="band">
        <div className="wrap">
          ...
          <div className="cards c2">
            ...
            <article className="card rv"><span className="num">05</span><h3>Habits &amp; nutrition</h3><p>The daily standard, practice structure and game habits — plus a specialized hockey nutrition and meal plan with Membership. The unglamorous part that decides everything.</p></article>
      ...
      <section id="complete-system">
        <div className="wrap">
          <div className="head center rv">
            <p className="eyebrow center">The Membership Program</p>
            <h2>A complete development<br />system, not just training</h2>
            <p className="lede mt2">Most players get skills coaching and nothing else — no strength plan, no nutrition, no film, no mental side. Membership puts all five together so they reinforce each other instead of competing for his time.</p>
          </div>
          ...
          <p className="center mt3"><Link className="btn btn-primary btn-lg" href="/pricing#membership" data-plan="membership" data-cta="membership_complete" data-cta-location="programs">See Membership — $49/month</Link></p>
        </div>
      </section>
