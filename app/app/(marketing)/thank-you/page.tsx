      ...
      <section>
        ...
        <div className="wrap-narrow center">
          ...
          <div className="cards c3 mt3" style={{ textAlign: 'left' }}>
            ...
            <article className="card"><span className="num">03</span><h3>Compare programs</h3><p>Membership and Custom Coaching side by side, so you know what to ask about on the call.</p><p className="mt1 small"><Link href="/pricing">See pricing →</Link></p></article>
          </div>
