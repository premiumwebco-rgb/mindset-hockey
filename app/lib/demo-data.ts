...
export const PRO_BREAKDOWNS: ProBreakdown[] = [
  { id: 'p1', slug: 'my-junior-a-wrist', title: 'My Wrist Shot — Junior A Season', playerLabel: 'Junior A Forward · Right Shot · Founder', level: 'junior', shotType: 'wrist', shoots: 'right', description: 'My own release, filmed to spec. Watch how little the upper body moves — everything comes from the transfer and the shaft.', releaseFrameMs: 1240 },
  { id: 'p2', slug: 'my-junior-a-snap', title: 'My Snap Shot Off The Catch', playerLabel: 'Junior A Forward · Right Shot · Founder', level: 'junior', shotType: 'snap', shoots: 'right', description: 'The puck is loaded before it arrives. Catch to release in about a third of a second.', releaseFrameMs: 980 },
  { id: 'p3', slug: 'junior-winger-wrist', title: 'Junior A Winger — Wrist Shot', playerLabel: 'Junior A Winger · Left Shot', level: 'junior', shotType: 'wrist', shoots: 'left', description: 'A teammate, filmed with consent. Note the hand separation against the clip above.', releaseFrameMs: 1420 },
  { id: 'p4', slug: 'junior-dman-point', title: 'Junior A Defenceman — Point Shot', playerLabel: 'Junior A Defence · Left Shot', level: 'junior', shotType: 'slap', shoots: 'left', description: 'Getting it through from the blue line is a posture and timing problem, not a power problem.', releaseFrameMs: 1610 },
